...
- xUnit coverage for money semantics, scenario generation, duplicate delivery, missing delivery, delayed delivery, out-of-order delivery, inconsistent-amount delivery, cutoff behavior, Fault Manifest isolation, and repeatability.

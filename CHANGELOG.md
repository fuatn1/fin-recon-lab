...
- Typed Fault Manifest entries for duplicate-delivery, missing-delivery, delayed-delivery, and out-of-order delivery faults.
...
- xUnit coverage for money semantics, scenario generation, duplicate delivery, missing delivery, delayed delivery, out-of-order delivery, cutoff behavior, Fault Manifest isolation, and repeatability.
